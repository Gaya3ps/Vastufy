...
export  const signupUser = createAsyncThunk(
  ...
  async (userData, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.post('http://vastufy.site/api/users/signup', userData );
...
export const GoogleAuth = createAsyncThunk(
  ...
  async (userData, { rejectWithValue }) => {
    try {
      const response = await axios.post('http://vastufy.site/api/users/googleAuth', userData );
...
export const forgotPassword = createAsyncThunk(
  ...
  async (email, { rejectWithValue }) => {
    try {
      const response = await axios.post('http://vastufy.site/api/users/forgot-password', { email });
...
export const resetPassword = createAsyncThunk(
  ...
  async ({ token, password }, { rejectWithValue }) => {
    try {
      const response = await axios.post('http://vastufy.site/api/users/reset-password', {
        token,
        password
      });
