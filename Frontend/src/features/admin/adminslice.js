...
export const fetchUsers = createAsyncThunk('admin/fetchUsers', async () => {
  const response = await axios.get('http://vastufy.site/api/admin/userlist');
  return response.data;
});

export const toggleUserStatus = createAsyncThunk('admin/toggleUserStatus', async ({ userId, isBlocked }) => {
  const response = await axios.post('http://vastufy.site/api/admin/block-user', { userId, is_blocked: isBlocked });
  return response.data;
});
...
try {
  ...
  const response = await axios.post('http://vastufy.site/api/admin/add-category', categoryData)
  return response.data;
  ...
  export const editCategory = createAsyncThunk('admin/editCategory', async (editCategoryData,{rejectWithValue})=>{
    ...
    const response = await axios.put(`http://vastufy.site/api/admin/edit-category/${id}`,data )
    return response.data
  ...
  export const deleteCategory = createAsyncThunk('admin/deleteCategory', async (deleteCategoryData,{rejectWithValue})=>{
    try {
      ...
      const response = await axios.delete(`http://vastufy.site/api/admin/delete-category/${id}`)
      return response.data;
  ...
  const response = await axios.post('http://vastufy.site/api/admin/add-subcategory', subCategoryData)
  return response.data;
...
const {id, ...data} = editSubcategory;
    ...
    const response = await axios.put(`http://vastufy.site/api/admin/edit-subcategory/${id}`,data);
    return response.data;
...
export const  deleteSubcategory = createAsyncThunk('admin/deleteSubcategory', async(deleteSubcategorydata,{rejectWithValue})=>{
  try {
    ...
    const response = await axios.delete(`http://vastufy.site/api/admin/delete-subcategory/${id}`)
    return response.data;
...
export const addSubscriptionPlan = createAsyncThunk(
  ...
  async (subscriptionData, { rejectWithValue }) => {
    ...
    try {
      const response = await axiosInstance.post('http://vastufy.site/api/admin/add-subscription-plan', subscriptionData);
