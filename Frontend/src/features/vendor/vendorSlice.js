...
export const vendorSignup = createAsyncThunk(
  ...
  async (vendorData, { rejectWithValue }) => {
    try {
      const response = await axios.post('https://vastufy.onrender.com/api/vendor/signup', vendorData);
...
export const updateVendorProfile = createAsyncThunk(
  ...
  try{
    ...
    const response = await axios.put(`https://vastufy.onrender.com/api/vendor/profile/${vendorData.id}`,vendorData);
    return response.data;
  }  catch (error){
    return rejectWithValue(error.response.data)
  }
