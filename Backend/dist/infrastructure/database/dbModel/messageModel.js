...
const MessageSchema = new mongoose_1.Schema({
    ...
    senderId: { type: mongoose_1.Schema.Types.ObjectId, refPath: 'senderModel', required: true },
    recipientId: { type: mongoose_1.Schema.Types.ObjectId, refPath: 'recipientModel', required: true },
