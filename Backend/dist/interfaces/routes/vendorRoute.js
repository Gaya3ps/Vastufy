...
vendorRouter.post("/uploadlicense", vendorAuthMiddleware_1.protectVendor, upload, vendorController_1.default.licenseUpload);
vendorRouter.get("/license/:id", vendorAuthMiddleware_1.protectVendor, vendorController_1.default.getLicenseNumber);
vendorRouter.put("/profile/:id", vendorAuthMiddleware_1.protectVendor, vendorController_1.default.updateVendorProfile);
vendorRouter.get("/categories", vendorAuthMiddleware_1.protectVendor, vendorController_1.default.getCategories);
vendorRouter.get("/subcategories", vendorAuthMiddleware_1.protectVendor, vendorController_1.default.getSubCategories);
...
vendorRouter.get("/bookings/:vendorId", vendorAuthMiddleware_1.protectVendor, vendorController_1.default.getBookings);
vendorRouter.put("/edit-property/:propertyId", uploadPropertyMedia, vendorController_1.default.updateProperty);
vendorRouter.get("/edit-properties/:id", vendorAuthMiddleware_1.protectVendor, vendorController_1.default.getPropertyById);
...
vendorRouter.get("/chats/:chatId", vendorAuthMiddleware_1.protectVendor, vendorController_1.default.fetchChatHistory);
vendorRouter.get("/chatList/:vendorId", vendorAuthMiddleware_1.protectVendor, vendorController_1.default.fetchChatList);
vendorRouter.post("/chats/:chatId/send", vendorAuthMiddleware_1.protectVendor, vendorController_1.default.sendMessage);
vendorRouter.get("/getVendorSubscription/:vendorId", vendorAuthMiddleware_1.protectVendor, vendorController_1.default.getVendorSubscription);
vendorRouter.get("/listed-subscription-plans", vendorAuthMiddleware_1.protectVendor, vendorController_1.default.getListedSubscriptionPlans);
